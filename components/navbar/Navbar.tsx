  ...
  return (
    <nav className="w-full h-fit lg:pt-8 py-3">
      <ul className="flex items-center w-full">
        ...
        <div className={`lg:w-5/12 fixed lg:static left-0 top-0 w-full lg:h-fit h-screen bg-blue-500/20 backdrop-blur-sm lg:bg-transparent flex lg:space-x-10 items-center lg:flex-row flex-col lg:p-0 p-10 space-y-3 transition-all duration-200 ${isMenu ? "left-0" : "-left-full"}`}>
        ...
        <li className="w-2/12 lg:flex ml-auto justify-end hidden">
          <a
            href="#"
